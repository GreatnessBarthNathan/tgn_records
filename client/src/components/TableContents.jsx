...
export const TableRow = ({
  ...
  return (
    <div className='bg-white hover:bg-indigo-100 grid grid-cols-12 w-full hover:cursor-pointer'>
      <p className='p-1 lg:p-2 text-[8px] md:text-xs lg:text-sm col-span-2 border border-t-0'>
        <Link to={`/dashboard/all-counts/${user}`}>{royalChapter}</Link>
      </p>
      <p className='p-1 lg:p-2 text-[8px] md:text-xs lg:text-sm col-span-3 border border-l-0 border-t-0'>
      ...
      <p className='p-1 lg:p-2 text-[8px] md:text-xs lg:text-sm col-span-1 border border-l-0 border-t-0'>
        <Link to={`/dashboard/all-counts/${user}`}>
